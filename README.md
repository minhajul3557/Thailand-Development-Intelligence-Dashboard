...
│
└── plots/                            # Pre-rendered interactive Plotly HTML figures
    ├── child_health_disparities.html
    ├── education_metrics.html
    ├── model_comparison_efficiency.html
    ├── model_comparison_quality.html
    ├── model_comparison_verbosity.html
    ├── poverty_vs_debt.html
    ├── radar_multidimensional_hdi.html
    └── regional_income_recovery.html
```
